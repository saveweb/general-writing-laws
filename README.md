...
「语言的空间划分」是为文字的不同语言部分划分区域。

1.  定义「语言环境」：

    例如下面的文章（短句）虽然含有英文单词或短语，但是主体仍然是简体中文：

    > apple 是传记 Steve Jobs 中 史蒂夫乔布斯 Steve Jobs 说过的词语
...
分别是法语、瑞士、德国／奥地利、中文、日语和英语的书名号表示方式。[^53627]
