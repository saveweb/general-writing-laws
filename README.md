...
+   GWLM 1-4：点号（点符号）
    ...
    用于句末的「句末点号」，表示一句话的结束。包括句号、问号、叹号。

    用于句内的「句内点号」，表示句内的各种停顿。包括逗号、顿号、分号、冒号。

+   GWLM 1-5 标号（标示符号）

    起到标示作用的符号，使用标号能够快速识别某段文字的作用。
...
GWLM 15834-4-5 是替代《GB/T 15834-2011 标点符号用法标准》4.5 小节的模块《律法》，描述了顿号的定义、
形式和基本用法。
...
GWLM 15834-4-17 是替代《GB/T 15834-2011 标点符号用法标准》4.17 小节的模块《律法》，
描述了分隔号的定义、形式和基本用法。
